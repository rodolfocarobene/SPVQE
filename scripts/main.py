...
from spvqe.iterator import from_item_iter_to_option, iterator_item_to_string
...
if __name__ == "__main__":
    ...
    JsonOptions = retrive_json_options(__file__, options, results)
